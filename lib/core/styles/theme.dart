...
ThemeData theme = ThemeData(
  drawerTheme: DrawerThemeData(backgroundColor: fischerBlue900),
  ...
  colorSchemeSeed: fischerBlue100,
  scaffoldBackgroundColor: fischerBlue900,
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    ...
    selectedItemColor: fischerBlue100,
  ...
  tabBarTheme: TabBarThemeData(
    ...
    unselectedLabelStyle: TextStyle(fontSize: 14, fontFamily: 'Alexandria'),
